...
func (a *App) mountProtectedRoutes(r chi.Router) {
	...
	r.Group(func(workspace chi.Router) {
		...
		workspace.With(a.requirePermission(PermMembersRead)).Get("/activity-log", a.listActivityLog)
		workspace.With(a.requirePermission(PermTicketingRead)).Get("/planner/smart", a.getPlannerSmart)
		workspace.With(a.requirePermission(PermMembersRead)).Get("/planner/events", a.listPlannerEvents)
		workspace.With(a.requirePermission(PermMembersWrite)).Post("/planner/events", a.createPlannerEvent)
		workspace.With(a.requirePermission(PermMembersWrite)).Delete("/planner/events/{id}", a.deletePlannerEvent)
		...
		workspace.With(a.requireFeature(FeatureInternalChat), a.requirePermission(PermMembersRead)).Get("/chat/conversations", a.listChatConversations)
		workspace.With(a.requireFeature(FeatureInternalChat), a.requirePermission(PermMembersRead)).Get("/chat/conversations/{id}/messages", a.listChatMessages)
		workspace.With(a.requireFeature(FeatureInternalChat), a.requirePermission(PermMembersWrite)).Post("/chat/conversations/{id}/messages", a.createChatMessage)
		...
		workspace.With(a.requireFeature(FeatureInternalChat), a.requirePermission(PermMembersRead)).Get("/message-templates", a.listMessageTemplates)
		workspace.With(a.requireFeature(FeatureInternalChat), a.requirePermission(PermMembersWrite)).Post("/message-templates", a.createMessageTemplate)
		workspace.With(a.requireFeature(FeatureInternalChat), a.requirePermission(PermMembersDelete)).Delete("/message-templates/{id}", a.deleteMessageTemplate)

		workspace.With(a.requireFeature(FeatureHR), a.requirePermission(PermMembersRead)).Get("/hr/hours", a.listHRHours)
		workspace.With(a.requireFeature(FeatureHR), a.requirePermission(PermMembersWrite)).Post("/hr/hours", a.createHRHour)
		workspace.With(a.requireFeature(FeatureHR), a.requirePermission(PermMembersRead)).Get("/hr/leaves", a.listHRLeaves)
		workspace.With(a.requireFeature(FeatureHR), a.requirePermission(PermMembersWrite)).Post("/hr/leaves", a.createHRLeave)
		workspace.With(a.requireFeature(FeatureHR), a.requirePermission(PermMembersRead)).Get("/hr/reviews", a.listHRReviews)
		workspace.With(a.requireFeature(FeatureHR), a.requirePermission(PermMembersWrite)).Post("/hr/reviews", a.createHRReview)
		workspace.With(a.requireFeature(FeatureHR), a.requirePermission(PermMembersWrite)).Post("/hr/certificates", a.createHRCertificateRequest)

		workspace.With(a.requirePermission(PermMembersRead)).Get("/automation-rules", a.listAutomationRules)
		workspace.With(a.requirePermission(PermMembersWrite)).Post("/automation-rules", a.createAutomationRule)
		workspace.With(a.requirePermission(PermMembersWrite)).Put("/automation-rules/{id}", a.updateAutomationRule)
		workspace.With(a.requirePermission(PermMembersDelete)).Delete("/automation-rules/{id}", a.deleteAutomationRule)

		workspace.With(a.requirePermission(PermMembersRead)).Get("/reports/overview", a.getReportsOverview)
